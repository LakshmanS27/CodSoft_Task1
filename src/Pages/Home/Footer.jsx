  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/profile.php?id=100007305315749"
            ...
            <li>
              <a
                href="https://www.instagram.com/lakshman_1.61/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://twitter.com/Laksh257"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/lakshman-shanmugam-00bb42267"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">© Lakshman Shanmugam 2023. All Rights Reserved.</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
